...
public class LeshanClientDemo {
	...
	static long startTimeBootstrap;
	static long endTimeBootstrap;
	
	static long startTimeServer;
	static long endTimeServer;
                        ...
                        handshaker.addSessionListener(new SessionAdapter() {
                            ...
                            public void handshakeStarted(Handshaker handshaker) throws HandshakeException {
                                if (handshaker instanceof ResumingServerHandshaker) {
                                    ...
                                    if(cont==0) {
                                    	startTimeBootstrap = System.currentTimeMillis();
                                    }else if(cont==1){
                            ...
                            public void sessionEstablished(Handshaker handshaker, DTLSSession establishedSession)
                                ...
                                if (handshaker instanceof ResumingServerHandshaker) {
                                    ...
                                    if(cont==0) {
                                    	endTimeBootstrap = System.currentTimeMillis();
                                    }else if(cont==1){
                                    	endTimeServer = System.currentTimeMillis();
                                    }
                                    cont++;
                                    if(cont==2) {
                                    	endTime = System.currentTimeMillis();
                                    	long totalTime = endTime - startTime;
                                    	long totalTimeBootstrap = endTimeBootstrap -startTimeBootstrap;
                                    	long totalTimeServer = endTimeServer -startTimeServer;
                                    	long totalTimeBlockchain = totalTimeBootstrap + totalTimeServer;
                                    	long totalTimeWithoutBlockchain = totalTime - totalTimeBlockchain;
                                    	
                                    	LOG.info("Total time: " + totalTime + " ms");
                                    	LOG.info("Total time Bootstrap: " + totalTimeBootstrap + " ms");
                                    	LOG.info("Total time Server: " + totalTimeServer + " ms");
                                    	LOG.info("Total time Blockchain: " + totalTimeBlockchain + " ms");
                                    	LOG.info("Total time without Blockchain: " + totalTimeWithoutBlockchain + " ms");
                                    	LOG.info("Check: " + (totalTime-totalTimeBootstrap-totalTimeServer-totalTimeWithoutBlockchain) + " ms");
